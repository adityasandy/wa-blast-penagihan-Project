<?php 
$conn = mysqli_connect("localhost","root","327115","whatsapp");
...
function cari ($keyword){
	...
	jurusan LIKE'%$keyword%' AND '$keyword'!= NULL ";
	return query($query);
...
function upload(){
	...
	// cek apakah ada gambar yg di uload
	if ($error === 4) {
		echo "<script> alert('pilih gambar terlebih dahulu');
		</script>";
		return false;
	}
// validasi yang di upload
...
// //jika user yang dimasukan hanya spasi
...
//cek apakah username udah ada
	...
	if ($password !== $password2) {
		echo "<script> alert('konfirmasi password tiddak sesuai');
		</script>";
		return false;
	}
